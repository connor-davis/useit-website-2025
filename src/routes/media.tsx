    ...
    <div className="flex flex-col w-full h-auto space-y-5 lg:space-y-32 pb-5 lg:pb-32">
      <div className="flex flex-col w-full h-auto space-y-5 bg-primary px-5 lg:px-32">
        <div className="grid grid-cols-1 w-full items-center h-auto lg:grid-cols-2 gap-5 lg:gap-32 py-5 lg:py-32">
          <img src="/assets/media_one.jpg" className="w-full rounded-2xl" />

          <div className="flex flex-col w-full h-auto space-y-5 text-white">
            <div className="text-4xl">
              Navigating the path of{' '}
              <span className="font-bold">Good Governance</span> one desicion at
              a time
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col w-full h-auto space-y-8 px-5 lg:px-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 w-full h-auto gap-5">
          <div className="flex flex-col w-full h-auto space-y-5">
            <div className="text-2xl">Current & Past Annual Reports</div>

            <ul className="list-disc px-4 underline">
              <li>
                <a href="https://use-it.co.za/assets/img/Annual%20Report%202022%202023%20Final.pdf">
                  2023 Report
                </a>
              </li>
              ...
              <li>
                <a href="#">2018 Report</a>
              </li>

              <li>
                <a href="#">2017 Report</a>
              </li>
            </ul>
          </div>

          <div className="flex flex-col w-full h-auto space-y-5">
            <div className="text-2xl">Promoting Green Environment</div>

            <ul className="list-disc px-4 underline">
              <li>
                <a href="https://156c9157-d9cf-4d98-a423-ffd1268d3ad9.filesusr.com/ugd/9d400e_d7079c949e4b4c34a77d5827385ce66c.pdf">
                  Greener Livable City - Water and Sanitation Presentation
                </a>
              </li>

              <li>
                <a href="https://156c9157-d9cf-4d98-a423-ffd1268d3ad9.filesusr.com/ugd/9d400e_cfd48ce0129448c2a9de562c7329d5d6.pdf">
                  National Recycling Forum Presentation: Jacques Lightfoot
                </a>
              </li>

              <li>
                <a href="https://156c9157-d9cf-4d98-a423-ffd1268d3ad9.filesusr.com/ugd/9d400e_18095b0ab8244078bd2e25e7bba518f2.pdf">
                  Maximising the Value of Waste: Chris Whyte
                </a>
              </li>

              <li>
                <a href="https://156c9157-d9cf-4d98-a423-ffd1268d3ad9.filesusr.com/ugd/9d400e_f9d5903af8714fe792d73d43c8c0b510.pdf">
                  International Good Practice Presentation: Phakamile Mbonambi
                </a>
              </li>

              <li>
                <a href="https://156c9157-d9cf-4d98-a423-ffd1268d3ad9.filesusr.com/ugd/9d400e_dcdcfd5ec32c41e284fe2c4a6c44b0a0.pdf">
                  Institue of Waste Management of Southern Africa Presentation:
                  Aubrey Muswema
                </a>
              </li>

              <li>
                <a href="https://www.citizen.co.za/highway-mail/news-headlines/advertorial/2023/09/06/key-bricks-unlocking-the-future-of-building-on-the-african-continent/">
                  Key Bricks - unlockingthe future of building on the african
                  continent
                </a>
              </li>

              <li>
                <a href="https://www.citizen.co.za/highway-mail/?p=489648">
          ...
          <div className="flex flex-col w-full h-auto space-y-5">
            <div className="text-2xl">Our Development Strategy</div>

            <ul className="list-disc px-4 underline">
              <li>
                <a href="https://156c9157-d9cf-4d98-a423-ffd1268d3ad9.filesusr.com/ugd/9d400e_e4c6c5a3a23e4b36a82b01436614945a.pdf">
              ...
              <li>
                <a href="https://156c9157-d9cf-4d98-a423-ffd1268d3ad9.filesusr.com/ugd/9d400e_91ef490b0d04406bb915a842c246918f.pdf">
                  National Empowerment Fund Presentation: Phakamile Madonsela
                </a>
              </li>

              <li>
                <a href="https://156c9157-d9cf-4d98-a423-ffd1268d3ad9.filesusr.com/ugd/9d400e_f7e8dc24382540cfab3d01cfbb3a016f.pdf">
      ...
      <div className="flex flex-col w-full h-auto space-y-5 px-5 lg:px-32">
        <div className="grid grid-cols-1 w-full items-center h-auto lg:grid-cols-2 gap-5 lg:gap-32 py-5 lg:py-32">
          <div className="flex flex-col w-full h-auto space-y-5">
            <div className="text-4xl">
              <span className="font-bold">Levaraging Resources</span> To Build
              Opportunities In The{' '}
              <span className="font-bold">Green Economy</span>
            </div>
          </div>

          <img src="/assets/media_three.jpg" className="w-full rounded-2xl" />
        </div>
      </div>

      <div className="flex flex-col w-full h-auto space-y-8 px-5 lg:px-32">
        <div className="flex flex-col w-full h-auto space-y-4 items-center justify-center">
          <div className="font-bold text-4xl text-center">FAQ</div>
          <div className="w-32 h-2 bg-amber-200"></div>
        </div>
        ...
        <div className="w-full">
          <div className="space-y-4">
            <div className="bg-white border border-gray-200 rounded-lg">
              ...
              <div className="p-4 bg-gray-50 peer-checked:block hidden">
                <p>
